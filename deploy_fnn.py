...
parser.add_argument('--model_dir', type=str, default="", help="Directory where previously trained models are saved.")
...
if __name__ == "__main__":
    ...
    test_dl = create_dataloader(test_set, shuffle=False, batch_size=100)
    ...
    for run in range(1, run_num+1):
        ...
        model.load_state_dict(torch.load(join(args.model_dir, f"{run}/model_{run}.pt"), map_location=device))

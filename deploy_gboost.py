...
if __name__ == "__main__":
    ...
    if "author_true" in save_dir:
        training_data = pd.read_csv("experiments/target-level/author_true/training_data.csv")
    elif "target" in save_dir:
        training_data = pd.read_csv("experiments/target-level/training_data.csv")
    elif "sentence" in save_dir:
        training_data = pd.read_csv("experiments/sentence-level/training_data.csv")
    else:
